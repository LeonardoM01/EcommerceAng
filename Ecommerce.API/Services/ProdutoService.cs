...
public class ProdutoService : IProdutoService
{
    ...
    public async Task<Produto> AdicionarProdutoAsync(Produto produto)
    {
        ...
        await _historicoService.RegistrarHistoricoAsync(nameof(Produto), produto.Id, AcaoHistorico.Criacao, $"Produto {produto.Nome} criado com preço {produto.Preco}.");
    ...
    public async Task<bool> AtualizarProdutoAsync(int id, Produto produto)
    {
        ...
        await _historicoService.RegistrarHistoricoAsync(nameof(Produto), produtoExistente.Id, AcaoHistorico.Alteracao, detalhes);
